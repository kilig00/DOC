...
# # 设置工作目录（acolite 的路径）
# os.chdir("E:/LLL/Program/acolite-main")

try:
    ee.Authenticate() # ee.Authenticate(force=True)
    ee.Initialize(project='ee-kilig0045')
...
if __name__ == '__main__':
    input = "E:/LLL/01C/Data/GEE_S2_DIC/input_nc"
    output_nc = "E:/LLL/01C/Data/GEE_S2_DIC/output_acolite"
    output_csv = "E:/LLL/01C/Data/GEE_S2_DIC/output_csv"
    sources = ['Sentinel-2']
    point_list_dir = "E:/LLL/01C/Data/GEE_S2_DIC/test.csv"
